      ...
      <div class="settings-form">
        ...
        <div v-if="showConfirmation" class="confirmation-modal">
          <div class="modal-content">
            <h2>Are you sure?</h2>
            <p>Do you want to save these changes to your account?</p>
            <div class="modal-buttons">
              <button @click="confirmChanges" class="btn-yes">Yes</button>
              <button @click="cancelChanges" class="btn-no">No</button>
            </div>
          </div>
        </div>
